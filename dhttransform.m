...
n = 0;
im={'lgthouse.bmp'};%,'f16.jpg','baboon.jpg','sailboat.jpg','couple.jpg','house.jpg','kid.jpg','peppers.jpg','barbara.jpg','bear.jpg','TTU.jpg'};%,};
% for imm=1:length(im)
k=1; %psnrval=zeros(17,1);
for Qfac=746%2:2:34
  m=1;
%Qfac=4;
% T=0.012 
...
%H=im{1,imm};
H='lgthouse.bmp';%F16,safari10.jpg,woman.jpg,fiore.jpg,baboon.jpg,butrfly1.jpg,pine.jpg,barnfall.jpg,redrock2
W='3073232.tif';
%W='200100732.jpg';
...
% psnrval(k,1)=colorpsnr(watermarkedim,Host);
% %psnrval(1,k)=num2str(psnrval(1,k));
% 
% ssimval(k,1)=colorssim(watermarkedim,Host);
% hand=figure(2);
% subplot(131),imshow(Host),title('Original image');
% subplot(132),imshow('watermarked.bmp'),title([' PSNR=',num2str(psnrval(k,1)),' SSIM=',num2str(ssimval(k,1)),' Qfac=',num2str(Qfac)]);
%toc;
